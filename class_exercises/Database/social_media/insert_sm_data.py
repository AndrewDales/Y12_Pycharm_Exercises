...
with sqlite3.connect("sm_app.sqlite") as conn:
    ...
    cursor.executemany(insert_posts_query, posts_data)
    cursor.executemany(insert_comments_query, comments_data)
    cursor.executemany(insert_likes_query, likes_data)